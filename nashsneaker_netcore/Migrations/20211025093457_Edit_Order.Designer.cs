...
namespace NashSneaker.Migrations
{
    ...
    [Migration("20211025093457_Edit_Order")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NashSneaker.Data.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NashSneaker.Data.Size", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NashSneaker.Data.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NashSneaker.Data.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NashSneaker.Data.OrderDetail", b =>
                {
                    b.HasOne("NashSneaker.Data.Order", "Order")
            ...
            modelBuilder.Entity("NashSneaker.Data.Product", b =>
                {
                    b.HasOne("NashSneaker.Data.Category", "Category")
                        .WithMany("Products")
